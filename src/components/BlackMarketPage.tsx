          ...
          {showSwipeHint && (
            ...
            >
              <motion.div
                ...
                className="bg-black/90 backdrop-blur-md border border-[#FF205A]/40 px-3.5 py-2 flex items-center gap-2 rounded-full shadow-[0_0_20px_rgba(255,32,90,0.25)]"
              >
                <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-300 font-medium">Swipe</span>
                <ArrowRight size={10} className="text-[#FF205A] animate-pulse" />
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-8">
                {/* Service Title */}
                <div>
                  <h3 className="font-sans font-extrabold text-2xl sm:text-3xl text-white uppercase tracking-tight leading-none group-hover:text-[#FF6B8A] transition-colors duration-300">
                    {service.title}
                  </h3>
                  ...
                  <ul className="space-y-2.5">
                    {service.includes.slice(0, 3).map((item, idx) => (
                      <li key={idx} className="flex items-center gap-3 text-sm text-zinc-300 font-light">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#FF205A] shrink-0" />
              ...
              <div className="pt-10">
                <button 
                  ...
                  className="w-full py-4 px-6 bg-zinc-950/80 border border-zinc-800/80 hover:border-[#FF205A]/80 hover:shadow-[0_0_20px_rgba(255,32,90,0.2)] text-zinc-200 hover:text-white font-sans text-xs font-bold tracking-widest uppercase transition-all duration-300 rounded-lg relative overflow-hidden group/btn"
                >
